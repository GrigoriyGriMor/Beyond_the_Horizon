...
Shader "DawnShaderHDRP_V2/EyesTearHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 color97 = IsGammaSpace() ? float4(0,0,1,0) : float4(0,0,1,0);
				float2 uv_Normal = packedInput.ase_texcoord5.xy * _Normal_ST.xy + _Normal_ST.zw;
				#ifdef _USENORMAL_ON
				float4 staticSwitch95 = tex2D( _Normal, uv_Normal );
				#else
				float4 staticSwitch95 = color97;
				#endif
				float4 Normal98 = staticSwitch95;
				
				float dotResult84 = dot( packedInput.ase_normal , V );
				...
				float4 fetchOpaqueVal55 = ASEHDSampleSceneColor(screenPos.xy, 0.0, GetInverseCurrentExposureMultiplier());
				...
				surfaceDescription.Normal = Normal98.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Metallic86;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = Emission88.rgb;
				surfaceDescription.Smoothness = _Roughness;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = Alpha90;
				...
				#ifdef _HAS_REFRACTION
				surfaceDescription.RefractionIndex = Refraction92;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float dotResult84 = dot( packedInput.ase_normal , ase_worldViewDir );
				float clampResult85 = clamp( dotResult84 , 0.0 , 1.0 );
				float temp_output_81_0 = pow( clampResult85 , _Power );
				float lerpResult75 = lerp( _RelectionFront , _RelectionSide , temp_output_81_0);
				float Metallic86 = lerpResult75;
...
/*ASEBEGIN
Version=18912
2560;0;2560;1059;2259.855;500.8908;1.744369;True;False
...
Node;AmplifyShaderEditor.ColorNode;97;-405.2749,661.6963;Inherit;False;Constant;_Color0;Color 0;11;0;Create;True;0;0;0;False;0;False;0,0,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScreenPosInputsNode;56;-1386.159,1062.613;Float;False;1;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;94;-439.455,920.0811;Inherit;True;Property;_Normal;Normal;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;95;-51.2749,780.6963;Inherit;False;Property;_useNormal;use Normal;9;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;98;241.7251,781.6963;Inherit;False;Normal;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;47;-319.8629,-249.9895;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.9433962,0.9433962,0.9433962,0;0.9433962,0.9433962,0.9433962,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;87;-183.8795,46.4712;Inherit;False;86;Metallic;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;91;-183.4962,273.097;Inherit;False;90;Alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;99;-182.2749,-31.30371;Inherit;False;98;Normal;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;93;-181.7222,354.8226;Inherit;False;92;Refraction;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-180.3484,194.4284;Inherit;False;Property;_Roughness;Roughness;1;0;Create;True;0;0;0;False;0;False;0.95;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;89;-181.687,120.5456;Inherit;False;88;Emission;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;27;119,-66;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;DawnShaderHDRP_V2/EyesTearHDRP;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;42;Surface Type;1;  Rendering Pass;1;  Refraction Model;2;    Blending Mode;2;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;0;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Receive SSR Transparent;0;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
...
WireConnection;27;4;87;0
WireConnection;27;6;89;0
WireConnection;27;7;69;0
WireConnection;27;9;91;0
WireConnection;27;17;93;0
ASEEND*/
//CHKSM=D19AD5C4EF4267FBBB8BC3935719DD58CD9F9613