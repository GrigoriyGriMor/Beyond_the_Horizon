Shader "Unlit/SH_PP_ShrinkFromBlur"
{
    Properties
    {
            ...
            Pass
            {
                ...
                fixed4 frag(v2f i) : SV_Target
                {
                    ...
                    else
                    {
                        ...
                        float3 unEdited = tex2D(_MainTex, i.uv);

                        return float4(unEdited, pow(CurColor.a,_Contrast));
                        //return float4(pow(CurColor.a, _Contrast), pow(CurColor.a,_Contrast), pow(CurColor.a, _Contrast), pow(CurColor.a, _Contrast));
